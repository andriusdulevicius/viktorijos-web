          ...
          <div className="flex flex-wrap">
            {learnPoints.map((item: any, i: number) => {
              return (
                <div
                  key={i}
                  className="border py-2 px-3 rounded-3xl my-2 mx-1 tracking-wider hover:scale-105 transition ease-in-out duration-100 font-light hover:border-[#F5C8D1] hover:text-[#F5C8D1] hover:drop-shadow-[0_0px_20px_#ffffff2f] "
                >
                  <p>{item}</p>
                </div>
              );
